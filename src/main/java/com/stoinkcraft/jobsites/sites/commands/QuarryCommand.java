package com.stoinkcraft.jobsites.sites.commands;

import com.stoinkcraft.StoinkCore;
import com.stoinkcraft.jobsites.sites.sites.quarry.QuarryGui;
...
public class QuarryCommand implements CommandExecutor {
    ...
    private static final String PERMISSION = "stoinkcore.jobsite.quarry";
    ...
    public boolean onCommand(@NotNull CommandSender sender, @NotNull Command command,
        ...
        QuarrySite quarrySite = enterprise.getJobSiteManager().getQuarrySite();

        if (quarrySite == null || !quarrySite.isBuilt()) {
            ChatUtils.sendMessage(player, ChatColor.RED + "Your enterprise hasn't built the Quarry yet!");
            return true;
        }
